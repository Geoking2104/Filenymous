  ...
  return (
    <div>
      ...
      {parcels.map((p) => {
        ...
        return (
          <div key={ehStr} style={{ display:"flex",alignItems:"flex-start",gap:".9rem",padding:"1rem 1.1rem",background:"rgba(255,255,255,.05)",border:"1px solid var(--border)",borderRadius:"14px",marginBottom:".6rem",boxShadow:"var(--shadow)" }}>
